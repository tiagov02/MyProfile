...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    if(isset($_GET['id'])) {
        ...
        if (empty($education)) {
            exit('That record with that ID doesn\'t exist!');
        }
    }
    else{
        exit("Unauthorized please come back<a href=\"index.php\">here</a>!");
    }
}
?>
...
<div class="form-group mx-5 my-5">
    ...
    <form action="create.php" method="post">
        ...
        <input type="text" name="place" placeholder="Viana do Castelo" id="name" class="form-control" value="<?=$education['name']?>">
